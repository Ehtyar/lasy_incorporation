...
\label{l_f102_wsts}
\end{figure}
Combining the two elements and applying them to the laser, one should obtain a flying focus laser. Figure \ref{l_f_axiparabola} shows, what this will look like for a desired focal velocity $v_f=0.98c$ or $v_f=1.02c$.
