...
\begin{frame}{Implementing the flying focus}{The complete setup}
    ...
    \begin{enumerate}
        ...
        \end{itemize}
        \item \label{measure_point} Measure the beam waist $w$ and relative focus position $t_{focus}-f_0/c$ or $z_{focus}-t\cdot c$
        \item \label{prop_point} Propagate the laser some distance through the focus region
        \item Repeat steps \ref{measure_point} and \ref{prop_point} until the end of the focus region is reached
    \end{enumerate}
\end{frame}
\begin{frame}{Implementing the flying focus}{The complete setup}
	\begin{columns}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item ?
            \end{itemize}
            \item Relative focus position $t_{focus}-f_0/c$ or $z_{focus}-t\cdot c$:
            \begin{itemize}
                \item ?
            \end{itemize}
            \item All measurements taken statistically
        \end{itemize}
        \end{column}
        \begin{column}{0.45\textwidth}
...
\begin{frame}{Testing the flying focus laser}{First results}
    \begin{columns}
        ...
        \end{itemize}
        \vspace*{30pt}
        {\scriptsize Images: Comparing measurements from the simulations to the expected evolution. Top: From a Lasy simulation: $t-z/c$, Bottom: .}
        \end{column}
...
\begin{frame}{Testing the flying focus laser}{The same simulation in PIConGPU}
    \begin{columns}
        ...
        \end{itemize}
        \vspace*{30pt}
        {\scriptsize Images: Comparing measurements from the simulations to the expected evolution. Top: , Bottom: From a PIConGPU simulation: $z-t\cdot c$.}
        \end{column}
        \begin{column}{0.42\textwidth}
...
\begin{frame}{Summary}{These tests were done:}
    \begin{itemize}
        ...
        \item 
        \item The Lasy developers were contacted
    \end{itemize}
    \vspace*{20pt}
