...
\begin{frame}{Implementing the flying focus}{The complete setup}
	...
	\end{center}
\end{frame}
\begin{frame}{Implementing the flying focus}{The measurement}
    \begin{columns}
        \begin{column}{0.55\textwidth}
        \begin{itemize}
...
\begin{frame}{Testing the flying focus laser}{First results}
    ...
    \end{columns}
\end{frame}
\begin{frame}{Testing the flying focus laser}{The same simulation in PIConGPU}
    \begin{columns}
        \begin{column}{0.55\textwidth}
        \begin{itemize}
...
\begin{frame}{Testing the flying focus laser}{Checking the shapes of the optical elements}
    \begin{columns}
        \begin{column}{0.55\textwidth}
        \begin{itemize}
        ...
        \only<2>{\scriptsize Images: Top: The shape of the axiparabola according to different sources. Relative differences $\approx10^{-2}$. Bottom: The two sides of the differential equation the axiparabola is derived from. Relative differences $\approx10^{-5}$.}
        \end{column}
        ...
        \includegraphics[width=\columnwidth]{Images/axiparabola_de.png}}
        \end{column}
    \end{columns}
\end{frame}
\begin{frame}{Testing the flying focus laser}{Testing all the used modules}
    \begin{columns}
        \begin{column}{0.55\textwidth}
        \begin{itemize}
...
\begin{frame}{Outlook}
    \begin{itemize}
        ...
        \item Some tests conducted after writing the bachelors thesis:\begin{itemize}
            \item Trying different propagation methods
            \item Initialising the pulse with other pulse profiles
            \item Using Cartesian coordinates on nodes with lots of memory
        \end{itemize}
    \end{itemize}
    \vspace*{20pt}
