...
Um die Interaktionen zwischen Laser und Plasma mit dem Flying-Focus-Laser genauer zu untersuchen nutzt man "Particle-in-Cell" Simulationen wie PIConGPU. Ein Flying-Focus-Laser hat eine komplizierte Form und Phasenstruktur und war deshalb in PIConGPU bisher nicht verfügbar. Mit der Pytho-Bibliothek Lasy kann man allerdings einen Laserpuls simulieren, der mit optischen Elementen interagiert, und dadurch einen Flying-Focus-Laser modellieren. Diese Arbeit kombiniert die beiden Methoden und macht den Flying-Focus-Laser in PIConGPU verfügbar. 
