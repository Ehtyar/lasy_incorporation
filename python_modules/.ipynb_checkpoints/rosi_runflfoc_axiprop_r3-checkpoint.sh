...
#SBATCH --mem=1500000
#SBATCH --chdir=/home/marqua27/jupyter_notebooks/rosi_r3_flfoc_axiprop_out
#SBATCH -o stdout
#SBATCH -e stderr
...
echo 'starting...'
python runflfoc_axiprop_xyt.py $1 $2 "rosi" "r3" # percent c, num iterations, profile settings
